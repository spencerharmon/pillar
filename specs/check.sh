...
SPECS=(CoordinationCore Registration StreamingDB StreamdbIpfsStore StreamdbPersistence EventDAG IPAM WoTAuthority WebKeyAuth AntiEntropy Bootstrap Observability ObsIngestionSubstrate RetentionPolicy ResourceSet PSLCore IdentityLogin KeyDistribution Recovery Cells NodeCustodyLogin WebAuthnCustody BootstrapRequest LoginToken NamingAuthorityPlane GlobalIdentity SessionRegistry TrustArtifacts PillarUDP VersioningCompat PillarMessageFormat SchedulerController PillarIntegration PillarUdpClient PillarUdpMesh)
declare -A FLAGS=(
  ...
  [RetentionPolicy]="-deadlock"
  [ResourceSet]="-deadlock"
  [PSLCore]="-deadlock"
