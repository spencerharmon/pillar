...
pub static VERBS: &[VerbSpec] = &[
    ...
    VerbSpec {
        name: "portal",
        handler: |_v, args| crate::portal_cli::run(args),
    },
    VerbSpec {
        name: "render",
    ...
    VerbSpec {
        name: "member",
        handler: |_v, args| crate::apply_over_pillar_message::member(args),
    },
    VerbSpec {
        name: "kv",
        handler: |_v, args| crate::apply_over_pillar_message::kv(args),
    },
    VerbSpec {
        name: "doc",
        handler: |_v, args| crate::apply_over_pillar_message::doc(args),
    },
    VerbSpec {
        name: "sql",
        handler: |_v, args| crate::apply_over_pillar_message::sql(args),
    },
    VerbSpec {
        name: "object",
        handler: |_v, args| crate::apply_over_pillar_message::object(args),
    },
    VerbSpec {
        name: "explain",
